...
public struct ez {
    ...
    public static var topMostVC: UIViewController? {
        ...
        if topVC == nil {
//            UtilityFunctions.printToConsole(message: "EZSwiftExtensions Error: You don't have any views set. You may be calling them in viewDidLoad. Try viewDidAppear instead.")
        }
        return topVC
    }
...
//         = NotificationCenter.default.addObserver(forName: UIApplication.userDidTakeScreenshotNotification, object: nil, queue: mainQueue) {  in
